...
public class PinyinInitialsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pinyin_initials);

        if (getSupportActionBar() != null) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("拼音首字母");
        }
    ...
    private void initViews() {
        ...
        btnCopy.setOnClickListener(v -> {
            ...
            android.content.ClipData clip = android.content.ClipData.newPlainText("PinyinInitials", tvOutput.getText());
    ...
    private void convert() {
        ...
        tvOutput.setText(result.toString().toUpperCase());
    }
